        ...
        <div ref={wordRef} className={S.word}>
          <div className={S.york}>
            <div className={S.letter}>
              <Alphabets dataIndex={1} letterIndex={25} ref={letterRefs[0]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={2} letterIndex={15} ref={letterRefs[1]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={3} letterIndex={18} ref={letterRefs[2]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={4} letterIndex={11} ref={letterRefs[3]} />
            </div>
          </div>
          <p className={S.and}>&</p>
          <div className={S.dante}>
            <div className={S.letter}>
              <Alphabets dataIndex={5} letterIndex={4} ref={letterRefs[4]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={6} letterIndex={1} ref={letterRefs[5]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={7} letterIndex={14} ref={letterRefs[6]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={6} letterIndex={20} ref={letterRefs[7]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={9} letterIndex={5} ref={letterRefs[8]} />
            </div>
          </div>
        </div>
      </div>
